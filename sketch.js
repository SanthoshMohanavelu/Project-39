...
var jungle, invisiblejungle, shrub;
...
function setup() {
  ...
  restart = createSprite(400, 220, 30, 30)
  ...
  kangaroo.scale = 0.15;
  kangaroo.setCollider("rectangle",0,0, width - 100, height - 200)
  kangaroo.debug=true;
...
function spawnShrubs() {
  if (frameCount % 150 === 0) {
    ...
    shrub.scale = 0.05;
    shrub.lifetime = 400;
    shrub.setCollider("rectangle", 0, 0, width, 50)
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    obstacle.setCollider("rectangle",0,0,width - 300,200)
